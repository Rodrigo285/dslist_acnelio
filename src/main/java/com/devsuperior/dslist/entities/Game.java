...
public class Game {
    ...
    @Column(name = "short_description", length = 254, nullable = false, columnDefinition = "TEXT")
    private String shortDescription;

    @Column(name = "long_description", length = 1000, nullable = false, columnDefinition = "TEXT")
